...
| `status` | Nee | `open` / `in_behandeling` / `afgehandeld` / `geannuleerd`. Standaard `open`. Handig als je bv. een melding met terugwerkende kracht of als test meteen als afgehandeld wil aanmaken. |
